...
class DataProcessor(abc.ABC):
    ...
    def add_item(self, value: str) -> None:
        self.data.append((self.total_processed, value))
...
class JsonPlugin:
    def process_output(self, data: list[tuple[int, str]]) -> None:
        values = []
        for item in data:
            values.append('"item_' + str(item[0]) + '": "' + item[1] + '"')
        print("JSON Output:")
        print("{" + ", ".join(values) + "}")
...
if __name__ == "__main__":
    ...
    new_batch = [
        21,
        ["Simple text", "Stay healthy", "Keep learning"],
        [
    ...
    print("Send another batch of data:", new_batch)
